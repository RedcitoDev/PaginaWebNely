...
export default function Example() {
  return (
    <div className="bg-fixed bg-[url('https://images.unsplash.com/photo-1531789965484-b656c2777ae2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32">
