        ...
        <div>
            ...
            <section className="py-5 px-10 md:py-10 md:px-36">
                ...
                <div class="md:flex md:gap-20 md:justify-between ...">
                    <div className="md:flex md:gap-10 py-7 px-5 bg-slate-200 rounded-md drop-shadow-md hover:scale-105 ease-in-out duration-300">
                        ...
                        <p className="font-bold text-blue-600">Selecciona tu destino <br /> <span className="font-light text-slate-900">Elige algun hotel de tu preferencia o de igual manera contactanos para que obtengas mas informacion</span></p>
                    </div>
                    <div className="md:flex gap-10 py-7 px-5 bg-slate-200 rounded-md drop-shadow-md hover:scale-105 ease-in-out duration-300">
                        ...
                        <p className="font-bold text-blue-600">Promociones <br /> <span className="font-light text-slate-900">Contactarnos trae muchos beneficios ademas de ajustarnos a tu preferencia, contamos con muchas promociones</span></p>
                    </div>
                    <div className="md:flex gap-10 py-7 px-5 bg-slate-200 rounded-md drop-shadow-md hover:scale-105 ease-in-out duration-300">
            ...
            <section className="bg-gray-200">
                <div className="md:columns-2 items-center py-20">
                    <div className="md:px-40 drop-shadow-lg hover:scale-105 duration-300 ease-in-out">
                        <div className="py-40 bg-contain bg-no-repeat text-center bg-[url('https://www.grandvelas.com/resourcefiles/mainimages/grand-velas-los-cabos-panoramic.jpg?version=4052024152058')]">
                    ...
                    <div className="px-10 md:py-20">
                        ...
                        <h2 className="font-light text-blue-500">5 Dias 4 Noches</h2>
                        ...
                        <div className="columns-3 md:pr-96 px-5">
                            <ul class="list-disc list-outside font-light text-blue-600">
            ...
            <section className="bg-blue-600">
                <div className="md:flex justify-center py-20 px-5 md:px-0 gap-40">
                    ...
                    <div>
                        <ul class="max-w-md space-y-1 py-4 text-white list-none list-inside dark:text-white">
                            <h2 class="mb-2 text-2xl font-bold text-white dark:text-white">¿Qué es el servicio habitación?</h2>
                        ...
                        <ul class="max-w-md space-y-1 text-white py-4 list-none list-inside dark:text-white">
                            <h2 class="mb-2 text-2xl font-bold text-white dark:text-white">¿Cómo funciona el servicio habitación?</h2>
                            <li className="font-light">
                                La principal ventaja del servicio de habitación es que permite a los huéspedes disfrutar de sus comidas en la comodidad.
                            </li>
                        </ul>
                        <ul class="max-w-md space-y-1 text-white py-4 list-none list-inside dark:text-white">
                        <h2 class="mb-2 text-2xl font-semibold text-white dark:text-white">¿Qué es el servicio todo incluido?</h2>
                            <li className="font-light">
                        ...
                        <ul class="max-w-md space-y-1 text-white py-4 list-none list-inside dark:text-white">
                        <h2 class="mb-2 text-2xl font-semibold text-white dark:text-white">¿Comó funciona el todo incluido?</h2>
                            <li className="font-light">
                        ...
                        <ul class="max-w-md space-y-1 text-white py-4 list-none list-inside dark:text-white">
                        <h2 class="mb-2 text-2xl font-semibold text-white dark:text-white">¿Qué actividades están incluidas?</h2>
                            <li className="font-light">
                        ...
                        <ul class="max-w-md space-y-1 text-white py-4 list-none list-inside dark:text-white">
                        <h2 class="mb-2 text-2xl font-semibold text-white dark:text-white">¿Cuáles son las características de las habitaciones?</h2>
                            <li className="font-light">
            ...
            <section>
                <Contact />
                <div className="bg-white justify-between flex md:px-40 md:py-20">
                    <CardContact />
                </div>
            </section>
        </div>
